...
<div class="floatingBox span12">
    <div class="container-fluid">
        ...
        <form class="form-horizontal contentForm" action="" enctype="multipart/form-data" method="post" data-validate="parsley" onsubmit="return validateForm()">
            <?php
            $memID = $_GET['memberID'];
            ...
            $stmt -> execute();
            $stmt -> bind_result( $memberID, $firstName, $middleName, $lastName, $gender, $dobA, $membership_dateA, $classification, $department, $role, $employment_dateA, $marital_status, $home_phone, $work_phone, $moblie_phone, $personal_email, $work_email, $residential, $postal, $image);
                            ...
                            <div class="LightShadedBox">
                                ...
                                <table cellspacing="4" cellpadding="0" border="0">
                                    ...
                                    <tr class="control-group">
                                        ...
                                        <td class="TinyTextColumn">
                                            <div class="controls">
                                                <input type="text" value="<?php echo $middleName; ?>" class="span10" id="middleName" name="middleName" data-trigger="change"  data-minlength="0" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="control-group">
                                    ...
                                    <tr class="control-group">
                                        ...
                                        <td class="TinyTextColumn">
                                            ...
                                            <div class="controls">
                                                <?php
                                                $year = substr($dobA,0,4);
                                                $month = substr($dobA,5,2) ;
                                                $day = substr($dobA,8,2) ;
                                    ...
                                    <tr class="control-group">
                                        ...
                                        <td class="TinyTextColumn">
                                            ...
                                            <div class="controls">
                                                ...
                                                <?php
                                                $year = substr($membership_dateA,0,4);
                                                $month = substr($membership_dateA,5,2) ;
                                                $day = substr($membership_dateA,8,2) ;
                                    ...
                                    <tr class="control-group">
                                        ...
                                        <td class="TinyTextColumn">
                                            ...
                                            <div class="controls">
                                               ...
                                               <?php
                                               $year = substr($employment_dateA,0,4);
                                               $month = substr($employment_dateA,5,2) ;
                                               $day = substr($employment_dateA,8,2) ;
