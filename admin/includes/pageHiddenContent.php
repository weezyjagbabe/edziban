    ...
    <div id="collapsedSidebarContent">
        ...
        <div class="sidebarContent">
            <ul class="collapsedSidebarMenu">
                ...
                <li class="sublevel"><a href="process">logout<i class="icon-off"></i></a></li>
            </ul>
        </div>   
    </div>
        ...
        <div class="sidebarContent">
            ...
            <div class="profileBlock">
                <div class="profilePhoto">
                    <div class="usernameHolder">Admin</div>
                </div>
                <div class="profileInfo">
                    <p><i class="icon-map-marker"></i>#1, Liman St,Ambassadorial Enclave</p>
                    <p><i class="glyphicon-envelope"></i>hr@payswitch.com.gh</p>
                    <p><i class="icon-globe"></i>payswitch.com.gh</p>

                </div>
                <footer>
                	<a href="edit-user?memberID=1">
