<?php 
	/*************************************************************
	* Payswitch-Adwane Management System
	* Copyright (c) 2014 Mep Studio, All Rights Reserved. 
	* 
	* Form.php
 	*
	...
	class Form
	{
    	...
    	*/
   		function error($field)
   		{
      		...
      		{
         		return "<span style='color:#ff0000; padding: 0 50px; line-height: 70px;' >".$this->errors[$field]."</span>";
      		}
      		else
      		{
         		return "";
